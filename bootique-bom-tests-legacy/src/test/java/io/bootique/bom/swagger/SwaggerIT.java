...
public class SwaggerIT {
    ...
    @BQApp
    static BQRuntime app = Bootique.app("--server", "--config=classpath:io/bootique/bom/autoload.yml", "--config=classpath:io/bootique/bom/swagger/config.yml")
            .autoLoadModules()
    ...
    private void assertEqualsToResourceContents(String expectedResource, String toTest) {
        ...
        try (Scanner scanner = new Scanner(
                Objects.requireNonNull(getClass().getClassLoader().getResourceAsStream("io/bootique/bom/swagger/" + expectedResource)), "UTF-8")) {
