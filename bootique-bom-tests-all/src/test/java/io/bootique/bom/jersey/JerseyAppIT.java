...
public class JerseyAppIT {
	...
	public void testRun() throws InterruptedException, ExecutionException, TimeoutException {
		...
		app.newRuntime().startServer("--config=src/test/resources/com/nhl/bootique/bom/jersey/test.yml");
		...
		String expected1 = "bootique-jersey-resource1:--server,--config=src/test/resources/com/nhl/bootique/bom/jersey/test.yml";
		...
		String expected2 = "bootique-jersey-resource2:--server,--config=src/test/resources/com/nhl/bootique/bom/jersey/test.yml";
